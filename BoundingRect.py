...
for contour in contours:
    if cv2.contourArea(contour)>300:
        ...
        cv2.putText(result,f'Boundrect Output:',(x1,y1-80),cv2.FONT_HERSHEY_COMPLEX,fontScale=1,color=(255,255,255),thickness=2,lineType=cv2.LINE_AA)
...
cv2.imwrite("output/Boundrect.jpeg",result)
