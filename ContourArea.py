...
for i,contour in enumerate(contours):
    if cv2.contourArea(contour)>20000:
        ...
        cv2.putText(result,f'ContourArea Output:',(x,y-80),cv2.FONT_HERSHEY_COMPLEX,fontScale=1,color=(255,255,255),thickness=2,lineType=cv2.LINE_AA)
...
cv2.imwrite("output/Contour_Area.jpg",result)
